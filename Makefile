...
WOKWI_PROJECT_ID=341178296293130834

fetch:
# HACK: we don't need to fetch this as we have our own verilog source, manually created: src/user_module_341178296293130834.v
