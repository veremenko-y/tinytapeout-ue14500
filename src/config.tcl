...
set ::env(DESIGN_NAME) scan_wrapper_341178296293130834
...
set ::env(VERILOG_FILES) "$::env(DESIGN_DIR)/user_module_341178296293130834.v \
$::env(DESIGN_DIR)/scan_wrapper_341178296293130834.v"
